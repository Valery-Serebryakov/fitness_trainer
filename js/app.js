(() => {
    ...
    function onTouchStart(event) {
        ...
        if (swipingClassHasValue && e.target && e.target.shadowRoot && eventPath) $targetEl = dom(eventPath);
    ...
    function headerScroll() {
        ...
        document.addEventListener("windowScroll", (function(e) {
            ...
            if (scrollTop >= startPoint) {
                ...
                if (headerShow) {
                    if (scrollTop > scrollDirection) header.classList.contains("_header-show") ? header.classList.remove("_header-show") : null; else {
                        !header.classList.contains("_header-show") ? header.classList.add("_header-show") : null;
                        !header.classList.contains("_header-show_mod") ? header.classList.add("_header-show_mod") : null;
                    }
                    timer = setTimeout((() => {
                        !header.classList.contains("_header-show") ? header.classList.add("_header-show") : null;
                        !header.classList.contains("_header-show_mod") ? header.classList.add("_header-show_mod") : null;
                ...
                if (headerShow) {
                    ...
                    header.classList.contains("_header-show_mod") ? header.classList.remove("_header-show_mod") : null;
                }
            }
